        ...
        <v-card-actions fill-height style="height:90%;">  
            <v-container fluid grid-list-md fill-height style="padding:0px 10px 5px 10px;width:100%;">
                <v-layout row style="height:100%;width:100%;">
                    <v-flex d-flex md3>
                        <v-layout column>
                            <v-flex d-flex md5 style="justify-content:center;align-items:center;font-size:80px;background-color:rgb(219,219,219);margin:5px;">
                                {{faults.length}}
                            </v-flex>
                            ...
                            <v-flex d-flex md5>
                                <v-layout column>
                                    <v-flex d-flex v-for="fault in faults" :key="fault" 
...
import {globalStore} from "../main.js"
    ...
    export default {
        ...
        methods: {
            navTo()
            {
                this.$router.push( { path:  'engine-faults' } )
            }
